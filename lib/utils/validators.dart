...
class Validators {
  ...
  static String? username(String? value) {
    ...
    if (!regex.hasMatch(value)) return 'Username hanya boleh huruf, angka, dan underscore';
    return null;
  }
  ...
  static String? noHp(String? value) {
    ...
    if (!RegExp(r'^[0-9]+$').hasMatch(clean)) return 'Nomor HP hanya boleh angka';
    return null;
  }
  ...
  static String? jumlah(String? value, {int min = 1}) {
    if (value == null || value.trim().isEmpty) return 'Jumlah tidak boleh kosong';
  ...
  static String? kodeGalon(String? value) {
    if (value == null || value.trim().isEmpty) return 'Kode galon tidak boleh kosong';
